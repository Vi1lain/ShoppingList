package Vi1ain.My.Application.data_store
...
class DataStoreManager(val context: Context) {
    ...
    fun getStringPreference(key: String, defValue: String)= context.dataStore.data.map {
pref -> pref[stringPreferencesKey(key)]?: defValue
    }
    companion object{
